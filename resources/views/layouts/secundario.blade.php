...
<html lang= "es">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><img src="{{ asset('img/logos/logo_3a.png') }}" height="35px"></a>
                    {{-- href="#myPage" --}}
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Catálogos
                                <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a style="font-size: 11px" href="/catalogo" download="Catálogo 3A Branding.pdf">Productos 2019</a></li>
                                {{--catalogo href="./catalogos/cat.pdf" --}}
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="jumbotron text-center">
            <img src="{{ asset('img/logos/logo_3a.png') }}" class="logo">
